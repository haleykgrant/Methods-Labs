...
[![EM video](./Images/YoutubeVid.png){width="350" height="250"}](https://www.youtube.com/watch?v=iQoXFmbXRJA "EM video")
...
![](./Images/PoissonMixture.jpg){width=350px}
...
![](./Images/LatentVar.jpg){width=350px}
...
![](./Images/SubstituteStep.jpg){width=400px}
...
![](./Images/Maximize_theta.jpg){width=350px}

Maximizing with respect to $\lambda_1$ and $\lambda_2$:

![](./Images/Maximize_lambda.jpg){width=400px}
...
![](./Images/ObsLikelihood.jpg){width=350px}
...
![](./Images/InClassProb.jpg){width=300px}
![](./Images/InClassProb2.jpg){width=300px}


![](./Images/InClassProb3.jpg)


![](./Images/InClassProb4.jpg){width=300px}